<?php
    switch(@$_REQUEST["acao"]){
        case "cadastrar":  
            ...
            $id_b       = (int)consulta_id(); #pega o id do beneficiario conforme o documento que ele digitar.
            $placa      = $_POST["placa"];
            $chassi     = $_POST["chassi"];
        ...
        case "editar":
            ...
            include './views/editarVeiculoView.php'; #para pegar o id que vem pela tela
            ...
            if($dados==True || $dadoi==True){
                print "<script>alert('Não foi possivel atualizar o cadastro! Placa ou chassi já cadastrados');</script>";
